...
ddir = os.path.join(home, "data/VOCdevkit/")  # your ddir root

# note: if you used our download scripts, this should be right
VOCroot = ddir  # path to VOCdevkit root dir
COCOroot = os.path.join(home, "data/COCO/")  # path to COCO
URPCroot = os.path.join(home, "datasets/train_data/")  # path to URPC
